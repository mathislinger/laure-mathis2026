...
function initMap() {
    ...
    // Marker for Église de Sainte-Foy-d'Aigrefeuille
    var marker2 = new google.maps.Marker({
        position: {lat: 43.54279845553851, lng: 1.6102535831070146},
        map: map,
        title: "Église de Sainte-Foy-d'Aigrefeuille"
    });
}
...
$(document).ready(function () {
    ...
    var r = createCalendar({
        ...
        data: {
            title: "Mariage Laure et Mathis",
            start: new Date("Jun 13, 2026 16:00"),
            end: new Date("Jun 14, 2026 17:00"),
            address: "Château du Pujolet, 962 Route du Pujolet, 31570 Vallesvilles",
            description: "Nous avons hâte de vous retrouver pour ce grand jour. Pour toute question ou problème, veuillez contacter Laure ou Mathis.",
        },
    });
    $("#add-to-cal").html(r),
$("#rsvp-form").on("submit", function (e) {
    ...
    $.post("https://script.google.com/macros/s/AKfycbyPWBFrBkVdywbrxR50hX19tCn0RYGC9TbrCKtWtPmcjbKNvRwY0JqgZTqAu8ziBZCu/exec", t)
        .done(function (e) {
            console.log(e);
            if (e.result === "error") {
                $("#alert-wrapper").html(alert_markup("danger", e.message));
            } else if (e.result === "success_yes") {
                $("#alert-wrapper").html("");
                $("#rsvp-modal-yes").modal("show");  // modal for success_yes
            } else if (e.result === "success_no") {
                $("#alert-wrapper").html("");
                $("#rsvp-modal-no").modal("show");   // modal for success_no
            } else {
                // fallback in case of unexpected result
                $("#alert-wrapper").html(alert_markup("warning", "Unexpected response from server."));
            }
        })
        .fail(function (e) {
            console.log(e);
