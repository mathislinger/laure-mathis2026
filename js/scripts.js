$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Mariage de Laure et Mathis",

            // Event start date
            start: new Date('Jun 12, 2026 15:00'),
            ...
            end: new Date('Jun 14, 2026 14:00'),

            // Event Address
            address: '962 Rte du Pujolet, 31570 Vallesvilles',

            // Event Description
            description: "Nous avons hâte de vous retrouver pour ce grand jour. Pour toute question ou problème, veuillez contacter Mathis Linger au +33 7 83 90 64 37."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Juste une seconde!</strong> Nous enregistrons votre inscription.'));
            ...
            $.post('https://script.google.com/macros/s/AKfycbyo0rEknln8LedEP3bkONsfOh776IR5lFidLhJFQ6jdvRiH4dKvHZmtoIybvnxpxYr2cA/exec', data)
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', "<strong>Désolé!</strong> Problème server, contacter Mathis."));
                });
    });
